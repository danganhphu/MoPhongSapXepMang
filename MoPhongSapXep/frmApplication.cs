...
namespace MoPhongSapXep
{
    public partial class frmApplication : Form
    {
        ...
        private ThamSo thamSo = new ThamSo();

        private Color colorMove = Color.FromArgb(253, 99, 71);

        // Color colorMove = Color.FromArgb(9, 132, 227);
        private Color colorComplete = Color.FromArgb(176, 244, 230);

        private Color colorDefault = Color.FromArgb(255, 192, 203);
        private Color colorMergeU = Color.Linen;
        private Color colorMergeD = Color.FromArgb(143, 188, 143);
        ...
        #endregion numArray_ValueChanged
        ...
        #endregion functions conversion
        ...
        #endregion Handing alignment

        #endregion Hàm phân phối a cho b và c
            ...
            this.Invoke((MethodInvoker)delegate
            {
                for (int i = 0; i < thamSo.nOe - 1; i++)
                {
                    ...
                    for (int j = i + 1; j < thamSo.nOe; j++)
                    {
                        ...
                        ShowCodeListBox(7);
                        lbl_status_02.Visible = true;
                        lbl_status_02.Text = "So Sánh( a[min] , a[" + j + "] )";
                    ...
                    if (min != i)
                    {
                        ShowCodeListBox(10);
                        lbl_status_02.Visible = true;
                        lbl_status_02.Text = "Đổi chỗ ( a[i] , a[min] )";
            ...
            this.Invoke((MethodInvoker)delegate
            {
                for (int i = 0; i < thamSo.nOe - 1; i++)
                {
                    ...
                    for (int j = i + 1; j < thamSo.nOe; j++)
                    {
                        ...
                        lbl_status_02.Visible = true;
                        lbl_status_02.Text = "So Sánh( a[max] , a[" + j + "] )";
                    ...
                    if (max != i)
                    {
                        ShowCodeListBox(10);
                        lbl_status_02.Visible = true;
                        lbl_status_02.Text = "Đổi chỗ( a[i] , a[max] )";
            ...
            for (int i = thamSo.nOe / 2; i > 0; i /= 2)
            {
                ...
                for (int j = i; j < thamSo.nOe; j++)
                {
                    ...
                    for (int k = j; k >= i && thamSo.arrNode[k] < thamSo.arrNode[k - i]; k -= i)
                    {
                        ...
                        Refresh();
                        ShowCodeListBox(5);
                        lbl_status_02.Text = "Đổi chỗ(a[" + k + "],a[" + (k - 1) + "])";
                        lbl_status_02.Visible = true;
        ...
        private void InsertionSortincrease(int[] arrNode)
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                for (i = 1; i < thamSo.nOe; i++)
                {
                    ...
                    lbl_status_02.Visible = true;
                    lbl_status_02.Text = "So sánh(a[" + pos + "],a[i)";
                    ...
                    {
                        lbl_status_02.Visible = true;
                        lbl_status_02.Text = "Hoán vị(a[pos],a[i])";
                    }
                    Application.DoEvents();
                    this.Invoke((MethodInvoker)delegate
                    {
        ...
        private void Shift_increase(int l, int r)
        {
        ...
        private void Shift_giam(int l, int r)
        {
            int i, j, index_temp, x;
            Label temp;
            i = l;
        ...
        private void CreateHeap_increase(int n)
        {
            int l = n / 2 - 1;
            while (l >= 0)
            {
        ...
        private void CreateHeap_giam(int n)
        {
            int l = n / 2 - 1;
        ...
        private void HeapSortincrease(int n)
        {
            ...
            while (r > 0)
            {
                ...
                //
                lbl_status_02.Visible = true;
                lbl_status_02.Text = "Đổi chỗ( a[0] , a[" + r + "] )";
        ...
        private void HeapSortGiam(int n)
        {
            listCode.SelectedIndex = 2;
            int r;
            listCode.SelectedIndex = 3;
        ...
        private void Merge_increase(int nb, int nc, int k)
        {
        ...
        private void Merge_giam(int nb, int nc, int k)
        {
            int pa, pb, pc, ib, ic, kb, kc, lennb, lennc;
            //lưu những giá trị để đếm Node dư
            lennb = nb;
        ...
        //Hàm sắp xếp Merge
        private void MergeSortincrease()
        {
            lblA.Visible = true;
            lblC.Visible = true;
            lblB.Visible = true;
        ...
        private void ShowCode()
        {
            ...
            listCode.Font = new Font("Cascadia Mono", 12, FontStyle.Regular);
        ...
        #endregion bnt"Initial","Control","Debug","Create Array"_Click
        ...
        #endregion speedTrackBar_ValueChanged
        ...
        #endregion rad"Sort"_CheckedChanged
        ...
        private void bntByHand_CausesValidationChanged(object sender, EventArgs e)
        {
        }
